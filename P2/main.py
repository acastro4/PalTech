...
C3 = "green"
C4 = "orange"
TYPEOFCLUSTER = 3 # 0: Vertical, 1: Horizontal, 2: 45º, 3: 25 puntos por robot angulo dinamico
TYPEOFTSP = 0 # 0: christofides, 1: greedy_tsp
...
g1, g2, g3, g4, bordes = cluster.getCluster(X, Y, SIZE, POS_ROBOT_1, POS_ROBOT_2, POS_ROBOT_3, POS_ROBOT_4, TYPEOFCLUSTER)
...
# Grafos por cluster
GF_1, pathFinal_1, recorrido_1, pathSimple1 = path.getTSPPath(g1, TYPEOFTSP, C1, ax, True)
GF_2, pathFinal_2, recorrido_2, pathSimple2 = path.getTSPPath(g2, TYPEOFTSP, C2, ax, True)
GF_3, pathFinal_3, recorrido_3, pathSimple3 = path.getTSPPath(g3, TYPEOFTSP, C3, ax, True)
GF_4, pathFinal_4, recorrido_4, pathSimple4 = path.getTSPPath(g4, TYPEOFTSP, C4, ax, True)
...
# graficar
plotlib.addToGraph(X, Y, SIZE, g1, g2, g3, g4, C1, C2, C3, C4, TYPEOFCLUSTER, POS_ROBOT_1, bordes)
